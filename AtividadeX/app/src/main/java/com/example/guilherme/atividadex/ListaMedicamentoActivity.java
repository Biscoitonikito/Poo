...
import com.example.guilherme.atividadex.RVAdapters.MedicamentoAdapter;
...
import com.example.guilherme.atividadex.model.Periodo;
...
public class ListaMedicamentoActivity extends AppCompatActivity {
    ...
    private void setupViews() {
        ...
        medicamentoList = medicamentoBox.getAll();
    ...
    private void reloadData(){
        adapter = new MedicamentoAdapter(this, medicamentoBox);
